...
import { Link } from 'react-router-dom'; // OG anchor tags fetch new html documents from the server, but the Link component prevents some of the default behavior of <a> tags
